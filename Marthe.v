...
Require Import String Datatypes Arith List Omega.
...
Proof.
        ...
        induction S1.
        - assumption.
        - apply SomeSteps with m2. assumption. apply IHS1. assumption.
Qed.

Lemma OneStep code st st' : Step code st st' -> Steps code st st'.
Proof.
        intros step.
        apply SomeSteps with st'. assumption. constructor.
Qed.
...
Proof.
        ...
        induction H.
        - constructor.
        - apply Step_extend with (code' := code') in H. apply SomeSteps with (m2 := m2); assumption.
Qed.
...
Proof.
        intros H.
        induction H; try (simpl; rewrite Nat.add_succ_r; constructor).
        - assumption.
        - assumption.
        - simpl. rewrite Nat.add_sub_assoc. apply SJumpYes; omega. assumption.
        - assumption.
Qed.
...
Proof.
        intros H.
        unfold Step. rewrite pc_shift. rewrite get_app_r'.
        unfold n.
        assert (length code0 + pc m - length code0 = pc m). omega.
        rewrite H0.
        unfold Step in H. induction (list_get code (pc m)).
