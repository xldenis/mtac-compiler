...
let call_compiler ?profile:(profile=false) ml_filename =
  ...
  let library_paths = "/Users/xavier/Code/xldenis/mtac-compiler/plugin/_build/install/default/lib/mtaclite/plugin" :: include_dirs () @ load_path @ ["/Users/xavier/Code/xldenis/mtac-compiler/plugin/_build/install/default/lib/mtaclite/plugin"] in
  let include_dirs = List.flatten (List.map (fun x -> ["-I"; x]) library_paths) in
